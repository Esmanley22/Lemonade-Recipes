  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-yellow-400 p-6'>
        <div className='flex items-center flex-shrink-0 text-sky-600  mr-6'>
            <Link to='/' className='font-semibold text-xl tracking-tight hover:text-black'>Digit</Link>
        ...
        <div className="block">
            <Button 
                    ...
                    hover:text-black hover:border-black border-2">
        ...
        { isVisible ? ( 
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    <Button className="p-3 m-5 bg-yellow-500 justify-center rounded-lg hover:border-black border-2">
                        <div>
                        ...
                        <Button className='p-3 m-5 bg-yellow-500 justify-center rounded-lg hover:border-black border-2'>
                            <div>
                                <Link to="/" onClick={ () => { signInOnClick()}} className="flex place-items-center mt-4
                                 lg:inline-block lg:mt-0 text-white hover:text-black mr-4">
                                    Sign In
                                </Link>
                            </div>
                        </Button>
